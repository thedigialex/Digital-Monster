...
interface AuthApi {
    ...
    suspend fun getUserInventory(): Response<List<Inventory>>


    @GET("api/items")
    suspend fun getItems(@Query("type") type: String? = null): Response<List<Item>>
    ...
    @GET("api/user/digitalMonster/evolve")
    suspend fun evolveDigitalMonster(): Response<UserDigitalMonsterResponse>
