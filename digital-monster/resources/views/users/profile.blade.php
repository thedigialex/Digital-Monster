<x-app-layout>
    ...
    <x-container>
        ...
        <div class="mt-2 space-y-4 flex flex-col md:flex-row">
            <div class="flex-1 bg-neutral p-4 rounded-md">
                ...
                <x-fonts.paragraph class="text-primary"><strong>Tamer Level:</strong> {{ $user->tamer_level }}</x-fonts.paragraph>
                <x-fonts.paragraph class="text-primary"><strong>Tamer Exp:</strong> {{ $user->tamer_exp }}</x-fonts.paragraph>
                <x-fonts.paragraph class="text-primary"><strong>Bits:</strong> {{ $user->bits }}</x-fonts.paragraph>
                <x-fonts.paragraph class="text-primary"><strong>Max Monster Amount:</strong> {{ $user->max_monster_amount }}</x-fonts.paragraph>
                <x-fonts.paragraph class="text-primary"><strong>Score:</strong> {{ $user->score }}</x-fonts.paragraph>
            </div>
    ...
    <x-container>
        ...
        <x-fonts.paragraph>No items found for this user.</x-fonts.paragraph>
        @else
        <table class="min-w-full border border-primary border-4">
            <thead class="bg-primary">
                <tr>
    ...
    <x-container>
        ...
        <x-fonts.paragraph>No training equipment found for this user.</x-fonts.paragraph>
        @else
        <table class="min-w-full border border-primary border-4">
            <thead class="bg-primary">
                <tr>
