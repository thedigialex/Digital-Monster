<x-app-layout>
    ...
    <x-elements.container>
        <form action="{{ route('user.handleMonster', [$user->id, isset($userDigitalMonster) ? $userDigitalMonster->id : null]) }}" method="POST">
            @csrf
            <x-elements.input-label for="digital_monster_id">Select Monster:</x-elements.input-label>
            ...
            <div class="mb-4">
                <x-elements.input-label for="name">Monster Name:</x-elements.input-label>
            ...
            <div class="mb-4">
                <x-elements.input-label for="isMain">Is Main:</x-elements.input-label>
